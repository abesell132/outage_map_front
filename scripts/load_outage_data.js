function get_township_data() {
  return new Promise((resolve, reject) => {
    axios.get(`https://www.uppco.com/_uppco-outage-files/exampleData/sorted_uppco_township.json?timestamp=${new Date().getTime()}`).then((res) => {
...
function get_county_data() {
  return new Promise((resolve, reject) => {
    axios.get(`https://www.uppco.com/_uppco-outage-files/exampleData/sorted_uppco_county.json?timestamp=${new Date().getTime()}`).then((res) => {
